# Restaurant Website V5.1 publishing starter

This repository is the public publishing half of the V5.1 restaurant website program. One protected contract supports both student launch routes:
...
The restaurant’s private business-assets folder belongs in the V5.1 program folder, outside this GitHub repository. Only approved public-ready assets belong in `public/`.
...
infrastructure/                   protected V5.1 contracts and setup templates
...
- use manifest schema `2.0`, workflow `5.1`, and repository package spec `5.1`;
- use canonical relative manifest page paths such as `menu.html`, never `/menu.html`, `../menu.html`, an encoded path, or a URL;
