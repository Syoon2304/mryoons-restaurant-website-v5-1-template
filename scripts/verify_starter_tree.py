#!/usr/bin/env python3
"""Permit starter-mode CI only when public/ exactly matches the reviewed V5.1 shell."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if actual != expected:
        print("Starter public/ differs from the reviewed V5.1 shell.", file=sys.stderr)
        ...
        return 1
    print(f"Reviewed V5.1 starter tree verified: {actual}")
    return 0
