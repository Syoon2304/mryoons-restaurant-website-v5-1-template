#!/usr/bin/env python3
"""Shared public-tree and ZIP path policy for the V5.1 publishing system.
...
def load_policy(path: Path) -> dict[str, Any]:
    ...
    if policy.get("policy_version") != "2.0.0" or policy.get("package_filename") != "website.zip":
        raise _fail("policy.version", "Policy version and package filename must match the V5.1 contract.", str(path))
    integer_keys = (
